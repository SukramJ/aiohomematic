...
@pytest.mark.asyncio
async def test_central_config_enable_xml_rpc_server_true_false() -> None:
...
@pytest.mark.asyncio
async def test_central_config_load_un_ignore_and_use_caches() -> None:
...
@pytest.mark.asyncio
async def test_central_config_connection_check_port_precedence() -> None:
...
@pytest.mark.asyncio
async def test_central_config_enabled_interface_configs_and_url() -> None:
...
@pytest.mark.asyncio
async def test_central_connection_state_issue_tracking_and_logging(caplog: pytest.LogCaptureFixture) -> None:
...
async def test_central_unit_str(central_client_factory_with_homegear_client) -> None:
