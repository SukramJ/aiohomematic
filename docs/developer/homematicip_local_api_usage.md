...
**Generated by**: `script/scan_aiohomematic_calls.py --verify-methods` — re-run to refresh method
counts and verify against the currently checked-out codebase. For the authoritative mtime of any
doc, use `git log -1 --format=%cs -- <path>`.
