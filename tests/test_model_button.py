"""Tests for model/generic button data points of aiohomematic."""
...
class TestGenericButton:
    """Tests for DpButton data points."""
    ...
    async def test_button_basic_functionality(
        self,
        central_client_factory_with_homegear_client,
    ) -> None:
        """Test DpButton basic functionality and press action."""
...
class TestProgramButton:
    """Tests for ProgramDpButton data points."""
    ...
    async def test_program_button_functionality(
        self,
