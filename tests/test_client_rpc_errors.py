...
def test_rpc_context_fmt_variants() -> None:
...
def test_map_jsonrpc_error_auth_variants() -> None:
...
def test_map_jsonrpc_error_internal_and_default() -> None:
...
def test_map_xmlrpc_fault_mappings() -> None:
