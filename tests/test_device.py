...
async def test_device_config_pending(
    ...
    cache_hash = central.paramset_descriptions._cache_hash
    last_save_triggered = central.paramset_descriptions._last_save_triggered
    ...
    assert cache_hash == central.paramset_descriptions._cache_hash
    assert last_save_triggered == central.paramset_descriptions._last_save_triggered
