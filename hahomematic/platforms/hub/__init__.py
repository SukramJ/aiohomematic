...
def _get_new_hub_data_points(
    ...
    """Return data points as platform dict."""
    hm_hub_data_points: dict[HmPlatform, set[GenericHubDataPoint]] = {}
    for hm_hub_platform in HUB_PLATFORMS:
        hm_hub_data_points[hm_hub_platform] = set()

    for hub_data_point in data_points:
        if hub_data_point.is_registered is False:
            hm_hub_data_points[hub_data_point.platform].add(hub_data_point)

    return hm_hub_data_points
