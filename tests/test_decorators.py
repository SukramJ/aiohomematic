...
def test_inspector_sync_success_and_attribute(caplog: pytest.LogCaptureFixture) -> None:
...
def test_inspector_sync_homematic_exception_suppressed(monkeypatch: pytest.MonkeyPatch) -> None:
...
def test_inspector_sync_generic_exception_always_reraises(monkeypatch: pytest.MonkeyPatch) -> None:
...
def test_inspector_sub_service_skips_logging(monkeypatch: pytest.MonkeyPatch) -> None:
...
def test_inspector_sub_service_generic_exception(monkeypatch: pytest.MonkeyPatch) -> None:
...
@pytest.mark.asyncio
async def test_inspector_async_success_and_exception_handling(caplog: pytest.LogCaptureFixture) -> None:
...
def test_get_service_calls_and_cache(monkeypatch: pytest.MonkeyPatch) -> None:
...
def test_measure_execution_time_sync_and_message(caplog: pytest.LogCaptureFixture) -> None:
