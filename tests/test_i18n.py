...
class TestI18nBasicTranslation:
    ...
    def test_tr_fallback_to_base_catalog(self) -> None:
        ...
        text = i18n.tr("some.nonexistent.key")
    ...
    def test_tr_without_formatting_args(self) -> None:
        ...
        text = i18n.tr("exception.config.check.host.invalid")
...
class TestI18nLocaleManagement:
    ...
    def test_catalog_caching(self) -> None:
        ...
        i18n.set_locale("de")
        i18n.set_locale("de")
        text = i18n.tr("exception.create_central.failed", reason="Test")
        assert "Test" in text
    ...
    def test_set_locale_updates_active_catalog(self) -> None:
        ...
        i18n.set_locale("en")
        text_en = i18n.tr("exception.create_central.failed", reason="Error")

        i18n.set_locale("de")
        text_de = i18n.tr("exception.create_central.failed", reason="Fehler")
...
class TestI18nAsyncPreloading:
    ...
    async def test_preload_locale_none_defaults_to_en(self) -> None:
        ...
        # Should preload 'en'
        i18n.set_locale("en")
        text = i18n.tr("exception.config.invalid", failures="test")
        assert "test" in text
