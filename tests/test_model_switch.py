...
async def test_switch_schedule_unsupported(
    ...
    """Ensure we handle devices without schedule gracefully."""
    central, mock_client, _ = central_client_factory_with_homegear_client
    switch: CustomDpSwitch = cast(CustomDpSwitch, get_prepared_custom_data_point(central, "VCU2128127", 4))
...
@pytest.mark.asyncio
async def test_switch_schedule_conversion() -> None:
...
@pytest.mark.asyncio
async def test_switch_schedule_bitwise_conversion() -> None:
...
@pytest.mark.asyncio
async def test_switch_schedule_astro_mode() -> None:
...
@pytest.mark.asyncio
async def test_switch_schedule_empty_deactivated() -> None:
...
@pytest.mark.asyncio
async def test_switch_schedule_multiple_groups() -> None:
...
@pytest.mark.asyncio
async def test_switch_schedule_edge_cases() -> None:
...
@pytest.mark.asyncio
async def test_switch_schedule_duration_calculation() -> None:
...
@pytest.mark.asyncio
async def test_switch_schedule_sunset_example() -> None:
...
@pytest.mark.asyncio
async def test_switch_schedule_24_channels() -> None:
...
@pytest.mark.asyncio
async def test_switch_schedule_channel_combinations() -> None:
