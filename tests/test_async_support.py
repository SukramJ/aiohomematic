...
@pytest.mark.asyncio
async def test__async_create_task_tracks_and_removes_tasks(caplog: pytest.LogCaptureFixture) -> None:
...
@pytest.mark.asyncio
async def test_create_task_schedules_from_threadsafe_and_runs(monkeypatch: pytest.MonkeyPatch) -> None:
...
@pytest.mark.asyncio
async def test_run_coroutine_returns_result() -> None:
...
@pytest.mark.asyncio
async def test_async_add_executor_job_tracks_and_finishes(monkeypatch: pytest.MonkeyPatch) -> None:
...
@pytest.mark.asyncio
async def test_cancel_tasks_cancels_active_tasks() -> None:
...
def test_cancelling_returns_false_when_attribute_missing() -> None:
...
@pytest.mark.asyncio
async def test__await_and_log_pending_deadline_crossed_during_loop(monkeypatch: pytest.MonkeyPatch) -> None:
...
@pytest.mark.asyncio
async def test__await_and_log_pending_empty_pending_hits_final_return() -> None:
...
@pytest.mark.asyncio
async def test_cancel_tasks_skips_already_cancelled_task() -> None:
